...
var require_quote = __commonJS({
  "node_modules/javascript-stringify/dist/quote.js"(exports) {
    ...
    function stringifyPath(path4, next) {
      let result = "";
      ...
      const builder = references ? (value2, key) => {
        if (value2 !== null && (typeof value2 === "object" || typeof value2 === "function" || typeof value2 === "symbol")) {
          if (tracking.has(value2)) {
            unpack.set(path4.slice(1), tracking.get(value2));
            return valueToString(void 0, space, onNext, key);
          }
          tracking.set(value2, path4.slice(1));
        }
        return valueToString(value2, space, onNext, key);
      } : (value2, key) => {
        if (stack.has(value2))
...
// node_modules/@vue/create-eslint-config/templates/prettierrc-airbnb.json
...
// node_modules/@vue/create-eslint-config/templates/prettierrc-standard.json
...
// node_modules/@vue/create-eslint-config/templates/prettierrcs.cjs
var require_prettierrcs = __commonJS({
  "node_modules/@vue/create-eslint-config/templates/prettierrcs.cjs"(exports) {
...
// node_modules/@vue/create-eslint-config/package.json
var package_exports = {};
...
// node_modules/@vue/create-eslint-config/versionMap.cjs
var require_versionMap = __commonJS({
  "node_modules/@vue/create-eslint-config/versionMap.cjs"(exports, module2) {
...
// node_modules/@vue/create-eslint-config/index.js
...
// utils/banner.ts
var banner = 'Fvue - The "Jack Of All Trades" Framework';
    ...
    preOrderDirectoryTraverse(
      ...
      (filepath) => {
        if (filepath.endsWith(".js")) {
          ...
          if (fs3.existsSync(tsFilePath)) {
            fs3.unlinkSync(filepath);
          } else {
            fs3.renameSync(filepath, tsFilePath);
          }
        } else if (path3.basename(filepath) === "jsconfig.json") {
          fs3.unlinkSync(filepath);
        }
      }
    );
    const indexHtmlPath = path3.resolve(root, "index.html");
    const indexHtmlContent = fs3.readFileSync(indexHtmlPath, "utf8");
    fs3.writeFileSync(indexHtmlPath, indexHtmlContent.replace("src/main.js", "src/main.ts"));
  } else {
    preOrderDirectoryTraverse(
      root,
      () => {
...
Done.
`);
  console.log(bold(red(`PS: Add your firebase keys to ${result.projectName ?? result.packageName ?? defaultProjectName}/firebase/credentials.js
`)));
